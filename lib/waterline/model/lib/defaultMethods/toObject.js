  ...
  for (var association in this.proto.associations) {
    ...
    if (hasOwnProperty(this.proto.associations[association], 'value')) {
      ...
      if(!values || !values.forEach) {
        console.log('Raw association', this.proto.associations[association])
        console.log('Error with values', association, values)
        console.log('this.proto._properties', this.proto._properties)
        console.log('this.context._attributes', this.context._attributes)
        // console.log('this.proto', this.proto)
        // console.log('this.proto.associations', this.proto.associations)
      } else {
